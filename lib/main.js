...
const value = {
    string: {
        ...
        preference: {
            ...
            displayLabels: "mapler.displayLabels",
        }
    },
};
...
const ui = {
    ...
    dialog: {
        preference: {
            ...
            init: () => {
                ...
                ui.dialog.preference.display.labels.checked = preference.get(value.string.preference.displayLabels, true);
    ...
    map: {
        ...
        load: () => {
            ...
            ui.map.ctrl.on('load', () => {
                if (!preference.get(value.string.preference.displayLabels, true)) {
        ...
        getStyleFromPreference: () => {
            let index = preference.get(value.string.preference.selectedStyle, 0);
        ...
        setLabels: (display) => {
            preference.set(value.string.preference.displayLabels, display);
